            ...
            <div class="content">
                <div class="form-container">
                    ...
                    <form action="" class="form-horizontal">
                        ...
                        <label class="forget">
                            <a href="modalforget.html">Esqueceu a senha?</a>
                        </label>
                        <button class="btn">Login</button>
                    </form>

                    <label class="user-singup">
                        <a href="modalcasdastro.html">Ainda não tem uma conta?</a>
                    </label>
                </div>
            </div>
        </div>
...
.form-horizontal .forget a {
    color: #007bb7;
    transition: all 0.3s ease 0s;
}

.form-horizontal .forget a:hover {
    color: #555;
}
...
.btn {
    ...
    letter-spacing: 1px;
    width: 100%;
    padding: 0.81rem 0.94rem 0.81rem;
    margin: 0;
    border-radius: 10px;
